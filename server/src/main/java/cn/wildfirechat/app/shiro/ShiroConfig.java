...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/report.html", "anon");
        ...
        filterChainDefinitionMap.put("/api/user/config", "anon");
        filterChainDefinitionMap.put("/api/user/report", "perms[user:view]");
        filterChainDefinitionMap.put("/api/user/report_list", "perms[user:view]");
